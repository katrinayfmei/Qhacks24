...
train_dataset = train.flow_from_directory("arthritis/train", 
                                          target_size = (400,400), 
                                          batch_size = 32, 
                                          class_mode = 'binary')

validation_dataset = validation.flow_from_directory("arthritis/validate", 
                                          target_size = (400,400), 
                                          batch_size = 32, 
                                          class_mode = 'binary')
...
img = tf.keras.preprocessing.image.load_img('arthritis/itsarthritis.jpg', target_size=(400, 400))
