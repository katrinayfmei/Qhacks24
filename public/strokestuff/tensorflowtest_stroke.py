...
train_dataset = train.flow_from_directory("stroke/train", 
                                          target_size = (400,400), 
                                          batch_size = 3, 
                                          class_mode = 'binary')

validation_dataset = validation.flow_from_directory("stroke/validate", 
                                          target_size = (400,400), 
                                          batch_size = 3, 
                                          class_mode = 'binary')
...
img = tf.keras.preprocessing.image.load_img('stroke/notastroke.jpeg', target_size=(400, 400))
