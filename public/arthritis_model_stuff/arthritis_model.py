...
train_dataset = train.flow_from_directory("public/arthritis_model_stuff/arthritis_data/train", 
                                          target_size = (400,400), 
                                          batch_size = 32, 
                                          class_mode = 'binary')

validation_dataset = validation.flow_from_directory("public/arthritis_model_stuff/arthritis_data/validate", 
                                          target_size = (400,400), 
                                          batch_size = 32, 
                                          class_mode = 'binary')
